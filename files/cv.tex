...
\usepackage{hyperref}
\usepackage[backend=biber,style=apa,sorting=ydnt,url=false, doi=false, isbn=false, maxnames = 50]{biblatex}
...
\end{refsection}
\begin{refsection}
\nocite{rosenExaminationAgesStages, kwasneskiCharacterizingBeneficialChange, liaoEffectsPCITDosage, rosenParentChildInteractionTherapys}
