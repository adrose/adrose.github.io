...
\usepackage{hyperref}
\usepackage[natbib, backend=biber, style=apa, doi=false,sorting=ydnt]{biblatex}
...
\address{Homepage: \href{https://adrose.github.io}{\texttt{https://adrose.github.io}}}
\address{
\href{https://scholar.google.com/citations?user=8tLT5KYAAAAJ&hl=en}{Google Scholar} \\ 
 \href{https://github.com/adrose}{Github}
}
\address{Phone: (+1) 703-389-3187 \\ Email: \texttt{adon.rosen@gmail.com}} % Your phone number and email
...
\leavevmode\printbibliography[type=article, title={\small{Published}}]
\end{refsection}
\begin{refsection}
